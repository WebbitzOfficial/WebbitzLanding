          ...
          >
            ...
            <div className="space-y-4 max-w-md mx-auto md:mx-0">
              <div className="flex items-start gap-3 text-left">
                ...
                <p className="text-sm md:text-base text-gray-300 font-medium">Partner che parla la tua lingua</p>
              </div>
              <div className="flex items-start gap-3 text-left">
                <CheckCircle2 className="w-5 h-5 md:w-6 md:h-6 text-primary-400 mt-1 shrink-0" />
                <p className="text-sm md:text-base text-gray-300 font-medium">Focus sul successo misurabile</p>
              </div>
              <div className="flex items-start gap-3 text-left">
                <CheckCircle2 className="w-5 h-5 md:w-6 md:h-6 text-primary-400 mt-1 shrink-0" />
                <p className="text-sm md:text-base text-gray-300 font-medium">Niente sprechi di budget</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative z-10 glass-card p-4 rotate-3 hover:rotate-0 transition-transform duration-500 max-w-sm w-full">
              <div className="aspect-[4/5] bg-gray-700 rounded-2xl overflow-hidden relative">
                ...
                <div className="flex items-center justify-center h-full text-gray-500 italic px-8 text-center">
